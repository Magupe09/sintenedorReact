...
function Navbar() {
    ...
    console.log("Estado menuVisible:", menuVisible);
    console.log("Clases que se aplicarán:", `nav ${menuVisible ? 'oculto' : ''}`);
    ...
    return (
        <header className="header">
            ...
            <nav className='menu'>
                ...
                onClick={() => console.log("Clases actuales:", `nav ${menuVisible ? 'oculto' : ''}`)}>
                ...
                <button onClick={() => {
                    console.log("Estado actual:", menuVisible);
                    setMenuVisible(!menuVisible);
                    console.log("Nuevo estado:", !menuVisible);
